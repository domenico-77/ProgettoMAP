        ...
        if(l.isEmpty()){
            if(Utilita.chiediConferma("Non ci sono partite già avviate, vuoi iniziarne una nuova?", "Inserisci il nome", "Ritorna al menù di gioco")){
                ...
                do{
                    ...
                    if(nome.isEmpty()){
                        System.out.println("Nome inserito non valido, reinseriscine un altro");
                    }
                }while(nome.isEmpty());
            ...
            do{
                    ...
                    if(nome.isEmpty()){
                        ...
                        if(l.contains(prova)){
                           ...
                           risposta = false;
                        }else if(Utilita.chiediConferma("Partita non trovata, vuoi riprovare?", "inserire nome partita da continuare", "Ritorna al menù di gioco")){
                            risposta = true;
